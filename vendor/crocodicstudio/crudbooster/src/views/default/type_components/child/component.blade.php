                        ...
                        <div class='col-sm-10'>
                            <div class="panel panel-default">
                                ...
                                <div class="panel-footer" align="right">
                                    <input type='button' class='btn btn-sm btn-default' id="btn-reset-form-{{$name}}" onclick="resetForm{{$name}}()"
                                           value='{{trans("crudbooster.button_reset")}}'/>
                                    <input type='button' id='btn-add-table-{{$name}}' class='btn btn-sm btn-primary' onclick="addToTable{{$name}}()"
