...
<header class="main-header">
    ...
    <a href="{{url(config('crudbooster.ADMIN_PATH'))}}" title='{{Session::get('appname')}}' class="logo">
        <img src="{{ CRUDBooster::myLogotipo() }}" class="user-image" alt="{{CRUDBooster::getSetting('appname')}} " width="100%" />
    </a>
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li> <a title='Lock Screen' href="{{ route('getLockScreen') }}" class='btn btn-flat'><i class='fa fa-key'></i>
                    </a>
                </li>
