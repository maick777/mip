...
class PrivilegesController extends CBController
{
    public function cbInit()
    {
        ...
        $this->col[] = ["label" => "Nivel", "name" => "nivel"];
        $this->col[] = [
            "label" => "Superadmin",
            "name" => "is_superadmin",
        ...
        $this->form[] = ["label" => "Nivel", "name" => "nivel", 'required' => true];
    ...
    public function postAddSave()
    {
        ...
        if ($priv) {
            foreach ($priv as $id_modul => $data) {
                ...
                $arrs['is_download'] = @$data['is_download'] ?: 0;
                $arrs['is_dashboard'] = @$data['is_dashboard'] ?: 0;
        ...
        $roles = DB::table('cms_privileges_roles')->where('id_cms_privileges', CRUDBooster::myPrivilegeId())->join('cms_moduls', 'cms_moduls.id', '=', 'id_cms_moduls')->select('cms_moduls.name', 'cms_moduls.path', 'is_visible', 'is_create', 'is_read', 'is_edit', 'is_delete', 'is_download', 'is_dashboard')->get();
